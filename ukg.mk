...
# name
PRODUCT_RELEASE_NAME := DNA

# device
$(call inherit-product-if-exists, device/htc/dlx/dlx_device.mk)
...
PRODUCT_DEVICE := dlx
PRODUCT_BRAND := HTC
PRODUCT_NAME := ukg_dlx
PRODUCT_MODEL := HTC DROID DNA
PRODUCT_MANUFACTURER := HTC
PRODUCT_PROPERTY_OVERRIDES += ro.buildzipid=ukg.dlx.$(shell date +%m%d%y).$(shell date +%H%M%S)
...
PRODUCT_BUILD_PROP_OVERRIDES += \
    ...
    PRIVATE_BUILD_DESC="dlx-user 4.2.2 JDQ39 573038 release-keys" \
    BUILD_FINGERPRINT="htc/dlx:4.2.2/JDQ39/573038:user/release-keys"
